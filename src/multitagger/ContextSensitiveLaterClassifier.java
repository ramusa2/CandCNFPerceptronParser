...
import multitagger.layers.ContextSensitiveLaterClassifierLookupLayer;
...
public class ContextSensitiveLaterClassifier extends LogisticRegressionNN {



	//private LogisticRegressionNN net;

	private ContextSensitiveLaterClassifierLookupLayer myLookup;

	public ContextSensitiveLaterClassifier(int numHiddenNodes, int numCatsToLookAt, int contextWindowSize,  
		...
		this.myLookup = new ContextSensitiveLaterClassifierLookupLayer(
	...
	public double predict(MultitaggerTrainingSentence sentence, int i, int k,
			DoubleMatrix history) {
