...
class DepList implements Cloneable {
  ...
  public final int headIndex;// the index of the argument word in the chart
  ...
  public void printNotRec() {
    printNotRec(System.out);
  }

  private void printNotRec(PrintStream out) {
    out.print('[');
    if (rel != null) {
      if (extracted) {
        if (bounded) {
  ...
  public void printDepGrammar(PrintStream out) {
  ...
  public void printGeneratedWords(HeadWordList heads,
