...
class HeadWordList implements Cloneable {
  // Added by Ryan: the head POS tag
   ...
   * 
   * @see BinaryNode#BinaryNode(String, BinaryTree, BinaryTree)
   * @see BinaryNode#BinaryNode(String, BinaryTree)
   */
  ...
  public String asString() {
    StringBuffer tmp = new StringBuffer(word()).append('|')
                            .append(cat()).append(':').append(index + " ");
