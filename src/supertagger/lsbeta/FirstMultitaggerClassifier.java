...
public class FirstMultitaggerClassifier extends LogisticRegressionNN {
	...
	private FirstClassifierContextLookupLayer myLookup;
	
	public FirstMultitaggerClassifier(int numHiddenNodes, int numCatsToLookAt, int contextWindowSize,  
			int wordEmbeddingDimension, int categoryEmbeddingDimension,  int surroundingContextDepth,
			StringEmbeddings wordEmbeddings, StringEmbeddings categoryEmbeddings) {
		categoryEmbeddings.setDefault(START, getRandomVec(categoryEmbeddingDimension));
		categoryEmbeddings.setDefault(END, getRandomVec(categoryEmbeddingDimension));
		categoryEmbeddings.setDefault(UNKNOWN, getRandomVec(categoryEmbeddingDimension));
		this.myLookup = new FirstClassifierContextLookupLayer(
				numCatsToLookAt, contextWindowSize, wordEmbeddingDimension, categoryEmbeddingDimension,
				surroundingContextDepth, wordEmbeddings, categoryEmbeddings);
	...
	private DoubleMatrix getRandomVec(int dim) {
