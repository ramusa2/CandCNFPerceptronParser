...
public class RunFirstMultitaggerClassifier {
	...
	public static void main(String[] args) throws Exception {
		...
		FirstMultitaggerClassifier multitagger = new FirstMultitaggerClassifier(
				numHiddenNodes, numCatsToLookAt, cxtWindowWidth, wordDim, catDim, 
				cxtDepth, wordEmbeddings, categoryEmbeddings);
	...
	public static void doTest(FirstMultitaggerClassifier multitagger, MultitaggerTrainingData data) {
